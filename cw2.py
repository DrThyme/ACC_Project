...
def start_workers(bro_ip,ip_list):
    ...
    for ip in ip_list:
        ...
        if ip == bro_ip:
            ...
            cmd = "cd /home/ubuntu/ACC_Project/;python parse_file.py " + str(bro_ip)+" "+str(openstack_pw)+ " "+str(worker_name)+" "+str(openstack_usrname)+";cd /home/ubuntu/ACC_Project/;celery worker -l info --concurrency=1 -A worker_tasks"
